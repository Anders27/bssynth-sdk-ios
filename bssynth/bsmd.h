...
typedef enum
{
	...
	BSMD_CTRL_SET_AUDIO_INPUT = 13000, /* <customized version only> */
	BSMD_CTRL_GET_AUDIO_INPUT, /* <customized version only> */
	BSMD_CTRL_SET_AUDIO_INPUT_VOLUME, /* <customized version only> */
	BSMD_CTRL_GET_AUDIO_INPUT_VOLUME, /* <customized version only> */
	BSMD_CTRL_SET_AUDIO_INPUT_REVERB_SEND_LEVEL, /* <customized version only> */
	BSMD_CTRL_GET_AUDIO_INPUT_REVERB_SEND_LEVEL, /* <customized version only> */
	BSMD_CTRL_SET_AUDIO_INPUT_CHORUS_SEND_LEVEL, /* <customized version only> */
	BSMD_CTRL_GET_AUDIO_INPUT_CHORUS_SEND_LEVEL, /* <customized version only> */
	BSMD_CTRL_SET_AUDIO_INPUT_DELAY_SEND_LEVEL, /* <customized version only> */
	BSMD_CTRL_GET_AUDIO_INPUT_DELAY_SEND_LEVEL, /* <customized version only> */
